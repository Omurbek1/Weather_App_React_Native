...
export default function Weather({ weatherData, fetchWeatherData }) {
    ...
    function getBackgroundImg(weather) {
        if(weather === 'Снег') return snow
        if(weather === 'Ясно') return sunny
        if(weather === 'Дождь') return rainy
        if(weather === 'туман') return haze
        return haze;   
    }
            ...
            >
                ...
                <View style={styles.extraInfo}>
                    ...
                    <View style={styles.info}>
                        <Text style={{ fontSize: 18, color: 'white' }}>Влажность</Text>
                        <Text style={{ fontSize: 22, color: 'white' }}>{humidity} %</Text>
                    </View>

                    <View style={styles.info}>
                        <Text style={{ fontSize: 15, color: 'white' }}>Скорость ветра</Text>
